...
baseUrl = 'https://www.theorem.co/about/careers#current-openings'
url = "https://www.theorem.co/about/careers#current-openings"
...
table = []
results = soup.find_all("a",{"class":"link purple"})
...
# the_company = Company.objects.get(uniqueId='dc9cbc71')
